// Software: GDI-JS
// Version: 2.3.7
// Author: Ghosterx Yubay
// Website: https://adjibayu.biz.id
...
const authConfig = {
  "siteName": "Yubay Technology Index", // Website name
  "client_id": "Client id from Google Cloud Console", // Client id from Google Cloud Console
  "client_secret": "Client Secret from Google Cloud Console", // Client Secret from Google Cloud Console
  "refresh_token": "Your Refresh Token", // Authorize token
  ...
  "file_link_expiry": 99999, // expire file link in set number of days
...
const uiConfig = {
  ...
  "favicon": "https://i.imgur.com/PzAVJBD.png",
  // if logo is true then link otherwise just text for name
  "logo_link_name": "https://i.imgur.com/C0keNVj.png",
  "login_image": "https://i.imgur.com/PzAVJBD.png", // Login page logo image
  ...
  "company_name": "Yubay Tech Server", // Name next to copyright
...
const login_html = `<html>
   <head>
    ...
    <style id="compiled-css" type="text/css">.login,.image{min-height:100vh}.bg-image{background-image:url('https://i.imgur.com/ELLBmIG.png');background-size:cover;background-position:center center}#error-message{display:none}</style>
